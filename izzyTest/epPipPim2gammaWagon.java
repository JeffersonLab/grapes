...
/**
 *
 * epPipPim2gamma Skimming
 *
 * @author fxgirod
 */

public class epPipPim2gammaWagon extends BeamTargetWagon {

	static final double PionMass   = 0.13957f;

	public epPipPim2gammaWagon() {
		super("epPipPim2gammaWagon","fxgirod","0.0");
	}
													...
													if( g1_mom>0.15){
														...
														for(int ig2 = ig1+1; ig2 < n_g && !hasDVPipPimPi0P ; ig2++){
															...
															if( g2_mom>0.15){
																...
																if( g1_g2_angle>1 && VPI0.mass()>0.025 && VPI0.mass()<0.3 ){
