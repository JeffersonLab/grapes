...
public class ep2gamma extends BeamTargetWagon {

	public ep2gammaWagon() {
		super("ep2gammaWagon","fxgirod","0.0");
	}
					...
					if( e_mom>0.1*beamEnergy ){
						...
						for (int ip = 0; ip < n_p && !hasEta; ip++) {
							...
							if(  p_ene>0.94358 ){
								...
								for (int ig1 = 0; ig1 < n_g-1 && !hasEta ; ig1++) {
									...
									if( g1_mom>0.15){
										...
										for (int ig2 = ig1+1; ig2 < n_g && !hasEta ; ig2++) {
