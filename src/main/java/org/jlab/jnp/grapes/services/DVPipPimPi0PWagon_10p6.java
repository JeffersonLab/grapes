...
public class DVPipPimPi0PWagon_10p6 extends Wagon {
    ...
    public DVPipPimPi0PWagon_10p6() {
        super("DVPipPimPi0PWagon_10p6","fxgirod","0.0");
    ...
    public boolean init(String jsonString) {
        System.out.println("DVPipPimPi0PWagon_10p6 READY.");
        return true;
    }   
